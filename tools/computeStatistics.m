...
%                 correction(i) = 6;
    ...
    for iCorrection = 1:nCorrection
        ...
        elseif iCorrection==2
            figure(f1);subplot(2,1,2);
        elseif iCorrection==3
            figure(f2);subplot(2,1,1);
        elseif iCorrection==4
            figure(f2);subplot(2,1,2);
        elseif iCorrection==5
            figure(f3);subplot(2,1,1);
        else
            figure(f3);subplot(2,1,2);
        end
    ...
    ylabel('<\Delta L>');
    grid on;
    title('Corrected design (C=40 [nm])');
    legend('h_x','h_y','p','Orientation','horizontal','Location','Best');
    set(gca,'FontSize',12);
    ...
    grid on;
    set(gca,'FontSize',12);
    title('Corrected design (C=55 [nm])');
    legend('h_x','h_y','p','Orientation','horizontal','Location','Best');
    subplot(2,1,2);
    xlabel('Hole index');
    ylabel('<\Delta L>');
    grid on;
    title('Corrected design (C=60 [nm])');
    legend('h_x','h_y','p','Orientation','horizontal','Location','Best');
    close(h);
    set(gca,'FontSize',12);
end
